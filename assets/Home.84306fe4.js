import { _ as _export_sfc, r as ref, c as computed, o as onMounted, a as openBlock, b as createElementBlock, d as createBaseVNode, n as normalizeStyle, e as createVNode, w as withCtx, t as toDisplayString, f as createCommentVNode, F as Fragment, g as renderList, h as createTextVNode, T as Transition, i as withKeys, s as stores, j as storeToRefs, k as watch } from './index.7c8fa9a8.js';

const Megafon_vue_vue_type_style_index_0_scoped_eb6bcb36_lang = '';
  ...
  setup(__props) {
    ...
    const slides = [
        ...
        },
        {
            ...
            help: "Подчеркнуть, что мы не конкурируем с VK Music. Мы решаем другую задачу.",
        ...
        {
            id: 9,
            title: "Почему это интересно Мегафону",
            help: "Связать с МТС и существующим рынком.",
            description: "Bilbo позволяет построить полноценную музыкальную экосистему.",
            items: [
                "Поддержка молодых артистов",
                "Собственный музыкальный мир",
                "Creator economy",
                "Новые сценарии для подписчиков",
                "Удержание молодежной аудитории"
            ]
        },
        {
            id: 10,
            title: "Не замена VK Music",
            help: "Очень важный слайд для снятия возражений.",
            description: "Bilbo дополняет существующую музыкальную инфраструктуру.",
            items: [
                "VK Music — каталог и стриминг",
                "Bilbo — развитие артистов",
                "Bilbo — фан-сообщества",
                "Bilbo — монетизация",
                "Bilbo — социальные механики"
            ]
        },
        {
            id: 11,
...
const Megafon = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-eb6bcb36"],['__file',"D:/bilbo/presentations/src/pages/Home/components/Megafon.vue"]]);
